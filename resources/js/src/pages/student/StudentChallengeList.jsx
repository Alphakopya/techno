...
import { IoIosArrowDown , IoIosArrowUp } from "react-icons/io"; // Using Io5 for modern icons
import styles from "./StudentChallengeList.module.scss";
  ...
  useEffect(() => {
    const fetchTags = async () => {
      try {
        ...
        const allTags = [
          ...new Set(
            response.data.data.flatMap((problem) => problem.tags || [])
          ),
        ];
    ...
    <div className={styles.challengeList}>
      ...
      <div className={styles.pagination}>
        <button
          ...
          disabled={
            pagination.total_pages === 1 || pagination.current_page === 1
          }
        >
          Previous
        </button>
