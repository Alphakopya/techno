...
const GuestNavBar = () => {
  ...
  const isSignUpCredentialPage = location.pathname === "/signup";
  ...
  return (
    ...
    >
      <div className="navbar-brand">
        <Link to="/" className="navbar-logo" aria-label="TechnoMatch Home">
          TechnoMatch
        </Link>
      </div>

      {/* Only show "Home" link if on login page */}
      {isAuthPage ? (
                ...
                <ul className="navbar-links">
                  <li className="navbar-item">
                    <a
                      ...
                      className={`navbar-link ${
                        activeSection === "explore" ? "navbar-link-active" : ""
                      }`}
                  ...
                  <li className="navbar-item">
                    <a
                      href="#leaderboard"
                      className={`navbar-link ${
                        activeSection === "leaderboard" ? "navbar-link-active" : ""
                      }`}
